...
def menu(event):
    global x,y,jouer,gamestarted
    x,y=event.x,event.y
    if 200<=event.x<=350 and 100<=event.y<=150 and gamestarted==False:
        print("Nouvelle partie")
        startgame()
    if 200<=event.x<=350 and 170<=event.y<=220 and gamestarted==False:
        print("Scores")
    if 200<=event.x<=350 and 240<=event.y<=290 and gamestarted==False:
        print("Règles")
    if 200<=event.x<=350 and 310<=event.y<=360 and gamestarted==False:
        print("Quitter")
